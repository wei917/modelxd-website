...
| **XTell** | `/xtell` | required | X算命: temple street (八字/紫微/月老/關帝籤/媽祖籤/四面佛/九曜 Jyotish/占星塔 Western/姓名/測字). Charts, sticks and 流年 computed by code, read by chosen masters. **See `docs/XTELL-PAGE.md`.** |
