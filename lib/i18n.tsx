...
export const STRINGS: Record<string, Entry> = {
  ...
  'xeval.col.games':  { en: 'Games', 'zh-Hant': '對局', 'zh-Hans': '对局', ja: '対戦数', ko: '대국' },
