...
export const STRINGS: Record<string, Entry> = {
  ...
  'xd.mv.mood.upbeat':     { en: 'Upbeat', 'zh-Hant': '輕快', 'zh-Hans': '轻快', ja: '軽快', ko: '경쾌' },
  'xd.mv.mood.ballad':     { en: 'Ballad', 'zh-Hant': '深情', 'zh-Hans': '深情', ja: 'バラード', ko: '발라드' },
  'xd.mv.mood.rock':       { en: 'Rock', 'zh-Hant': '搖滾', 'zh-Hans': '摇滚', ja: 'ロック', ko: '록' },
  'xd.mv.mood.country':    { en: 'Country', 'zh-Hant': '鄉村', 'zh-Hans': '乡村', ja: 'カントリー', ko: '컨트리' },
  'xd.mv.mood.electronic': { en: 'Electronic', 'zh-Hant': '電子', 'zh-Hans': '电子', ja: 'エレクトロ', ko: '일렉트로닉' },
  'xd.mv.mood.hiphop':     { en: 'Hip-hop', 'zh-Hant': '嘻哈', 'zh-Hans': '嘻哈', ja: 'ヒップホップ', ko: '힙합' },
  'xd.mv.mood.folk':       { en: 'Folk', 'zh-Hant': '民謠', 'zh-Hans': '民谣', ja: 'フォーク', ko: '포크' },
  'xd.mv.mood.rnb':        { en: 'R&B', 'zh-Hant': 'R&B', 'zh-Hans': 'R&B', ja: 'R&B', ko: 'R&B' },
