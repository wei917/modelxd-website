...
export const STRINGS: Record<string, Entry> = {
  ...
  'ww.sec.human':        { en: 'Human', 'zh-Hant': '真人', 'zh-Hans': '真人', ja: '人間', ko: '사람' },
  'ww.sec.ai':           { en: 'AI', 'zh-Hant': 'AI', 'zh-Hans': 'AI', ja: 'AI', ko: 'AI' },
  ...
  'ww.search.note':      { en: 'Every seat can search, or none can. Billed per search on top of tokens — a full game costs noticeably more.', 'zh-Hant': '整桌都能搜，或都不能。搜尋按次計費、加在 token 費用之上——整局會明顯變貴。', 'zh-Hans': '整桌都能搜，或都不能。搜索按次计费、加在 token 费用之上——整局会明显变贵。', ja: '全席が検索できるか、誰もできないかのどちらかです。検索は回数課金でトークン料金に加算され、一局のコストは目に見えて上がります。', ko: '모든 자리가 검색하거나, 아무도 하지 않습니다. 검색은 횟수당 과금되어 토큰 요금에 더해지며, 한 판 비용이 눈에 띄게 올라갑니다.' },
