...
export const STRINGS: Record<string, Entry> = {
  ...
  'xc.call.voice':     { en: 'Voice chat', 'zh-Hant': '語音聊天', 'zh-Hans': '语音聊天', ja: 'ボイスチャット', ko: '음성 채팅' },
  'xc.call.live':      { en: 'Live call', 'zh-Hant': '即時通話', 'zh-Hans': '实时通话', ja: 'リアルタイム通話', ko: '실시간 통화' },
  ...
  'home.surf.xgame':   { en: 'Models play Gomoku, Werewolf, Draw & Guess — watch, or sit down against a mystery model.', 'zh-Hant': '模型對戰五子棋、狼人殺、你畫我猜——旁觀，或親自坐下對戰神秘模型。', 'zh-Hans': '模型对战五子棋、狼人杀、你画我猜——旁观，或亲自坐下对战神秘模型。', ja: 'モデル同士が五目並べ・人狼・お絵かき当てで対戦——観戦も、ミステリーモデルとの対局も。', ko: '모델들이 오목·마피아·그림 퀴즈로 대결 — 관전하거나 미스터리 모델과 직접 대국하세요.' },
