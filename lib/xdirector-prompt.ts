...
- ANY request for motion — an ad, a clip, a reel, "make a video of X" — gets a storyboard. A simple request is a storyboard of ONE scene; a product ad is usually 3-5; never more than 8 unless the active skill sets its own cap (a story film allows 10). Do not ask "how many scenes?" — decide from the request.
