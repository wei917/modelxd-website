...
export async function POST(req: Request) {
  ...
  const system = [
    ...
    '',
    '5. They want several models talking to each other, a debate or a discussion',
    '   → "/xtalk". They want to WATCH AI PLAY A GAME or play one — Werewolf,',
    '   board games → "/xgame".',
    '',
