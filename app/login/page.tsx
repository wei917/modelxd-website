    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .login-hero, .login-features, .login-why, .login-cta-bottom { padding-left: 24px; padding-right: 24px; }
        }
      ...
      {/* What's locked */}
      <div style={{ borderTop: '1px solid var(--border)', padding: '0 48px' }}>
        <div className="login-features" style={{ padding: '80px 0' }}>
      ...
      {/* Why we need login */}
      <div style={{ borderTop: '1px solid var(--border)', padding: '0 48px' }}>
        <div className="login-why" style={{ padding: '80px 0' }}>
      ...
      {/* Bottom CTA */}
      <div className="login-cta-bottom" style={{ borderTop: '1px solid var(--border)' }}>
        ...
        <p className="login-note" style={{ marginTop: 16 }}>Leaderboard and Feed are always public · No login required</p>
      </div>
